...
function SetLan(ass) {
    ...
    if (page == "wl_member") {
        if (ass == "Thai") {
            $('.fieldLogin, .fieldStart, .fieldBet').css('padding-left', '1rem');
            $('.fieldLogin').css('padding-left', '1.7rem');
            $('.fieldStart').css('padding-left', '2.6rem');
        }
        else if (ass == "English") {
            $('.fieldLogin, .fieldStart, .fieldBet').css('padding-left', '1rem');
            $('.fieldBet').css('padding-left', '2.2rem');
            $('.fieldStart').css('padding-left', '1.6rem');
        }
        else if (ass == "Chinese") {
            $('.fieldLogin, .fieldStart, .fieldBet').css('padding-left', '1rem');
            $('.fieldLogin').css('padding-left', '1.8rem');
        }
    }

    if (ass == '' || ass == 'undefined') {
        ass = getCookie('lan');
    }
    //$('#inputlan').val(ass);
    setCookie('lan', ass);
    ...
    $('[set-lan]').each(function () {
        ...
        if (t == undefined) t = English[m];
        if (t == undefined) t = Thai[m];
        if (t == undefined) t = Chinese[m];
        if (t == undefined) return true;

        //var txtHouseLan = "";
        //if (m == "Member W/L(100%)") {
        //    txtHouseLan = t + " " + me.attr("valHouse");
        //}
        //else {
        //    txtHouseLan = t;
        //}
