<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sportbook.aspx.cs" Inherits="Support_Project.Menu_Sportbook.Sportbook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#menuSportbook > a").addClass("active");
        ...
        function GetData() {
            ...
            dataAdd.limit = "100";
            $.ajax({
                url: "https://support-sportbook-api.secure-restapi.com/football/chanel/findTicketRunningByBet-sportbook",
                type: 'POST',
                dataType: 'json',
                        ...
                        if (data.result.code == 0) {
                            ...
                            if (dataTotal.length > 0 && dataTotal != "") {
                                for (var i = 0; i < dataTotal.length; i++) {
                                    ...
                                    //if (obj.gameType != "MIX_STEP") {
                                    htmlData += "<tr style='display: none;'>";
                                    htmlData += "<td colspan='7'>";
                                    htmlData += "<table class='table table-border'>";
                                    htmlData += "<thead class='rgba-green-slight'>";
                                    htmlData += "<tr>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Match ID</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>MD5</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Odd key</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Odd</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Odd type</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Handicap</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Bet</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>score</th>";
                                    htmlData += "<th style='background-color: #007bff !important;'>Match type</th>";
                                    //htmlData += "<th style='background-color: #007bff !important;'>Full score</th>";
                                    //htmlData += "<th style='background-color: #007bff !important;'>Half score</th>";
                                    htmlData += "</tr>";
                                    htmlData += "</thead>";
                                    htmlData += "<tbody>";

                                    //if (obj.gameType == "TODAY") {
                                    var arrHDP = obj.hdp;
                                    htmlData += "<tr style='background-color: #e2e2e2;'>";
                                    htmlData += "<td>" + arrHDP.matchId + "</td>";
                                    htmlData += "<td>" + arrHDP.md5 + "</td>";
                                    htmlData += "<td>" + arrHDP.oddKey + "</td>";
                                    htmlData += "<td>" + arrHDP.odd + "</td>";
                                    htmlData += "<td>" + arrHDP.oddType + "</td>";
                                    htmlData += "<td>" + arrHDP.handicap + "</td>";
                                    htmlData += "<td>" + arrHDP.bet + "</td>";
                                    htmlData += "<td>" + arrHDP.score + "</td>";
                                    htmlData += "<td>" + arrHDP.matchType + "</td>";
                                    //htmlData += "<td>" + arrHDP.fullScore + "</td>";
                                    //htmlData += "<td>" + arrHDP.halfScore + "</td>";
                                    htmlData += "</tr>";
                                    //}
                                    //else if (obj.gameType == "PARLAY" || obj.gameType == "MIX_STEP") {
                                    //    var arrParlay = obj.parlay.matches;
                                    //    for (var x = 0; x < arrParlay.length; x++) {
                                    //        htmlData += "<tr style='background-color: #e2e2e2;'>";
                                    //        htmlData += "<td>" + arrParlay[x].matchId + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].md5 + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].oddKey + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].odd + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].oddType + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].handicap + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].bet + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].score + "</td>";
                                    //        htmlData += "<td>" + arrParlay[x].matchType + "</td>";
                                    //        //htmlData += "<td>" + arrHDP.fullScore + "</td>";
                                    //        //htmlData += "<td>" + arrHDP.halfScore + "</td>";
                                    //        htmlData += "</tr>";
                                    //    }
