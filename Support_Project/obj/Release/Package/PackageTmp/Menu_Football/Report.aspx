<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="Support_Project.Menu_Football.Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#menuFootball > a").addClass("active");
        ...
        function GetData() {
            ...
            dataAdd.limit = "100";
            $.ajax({
                url: "https://support-sportbook-api.secure-restapi.com/football/chanel/findTicketRunningByBet",
                type: 'POST',
                dataType: 'json',
