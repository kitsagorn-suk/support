...
namespace Support_Project.Menu_Management_Main
{
    public partial class Company : System.Web.UI.Page
    {
        ...
        public void DeleteCompany_click(Object sender, EventArgs e)
        {
            ...
            if (_idDel != 0)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alertModal", "alertModal('Delete company success.');", true);
                SearchData();
            }
            else
            {
        ...
        public void EditCompany_click(Object sender, EventArgs e)
        {
            ...
            if (_idChk == 0)
            {
                ...
                if (_id != 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertModal", "alertModal('Edit company success.');", true);
                    SearchData();
                }
                else
                {
