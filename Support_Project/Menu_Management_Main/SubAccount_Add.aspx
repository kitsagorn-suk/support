<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SubAccount_Add.aspx.cs" Inherits="Support_Project.Menu_Management_Main.SubAccount_Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active txtMem" set-lan="text:Add Sub Account"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-8">
    ...
    <div class="section-group mb-4 col-6">
        ...
        <div class="form-row">
            <div class="col-12" style="text-align: center;">
                <button id="bAdd" class="btn btn-yellow font-weight-bold" onclick="SaveMember()" type="button" set-lan="text:Add Sub Account"></button>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#menuManagementMain , #menuManagementMain > a , #menuManagementSubAccountAdd > a").addClass("active");
...
function alertModalDuplicate(txtAlert) {
    ...
    SetLan(localStorage.getItem('Language'));
        ...
        function alertModal(txtAlert) {
            ...
            if (txtAlert == "Add new sub account success.") {
                setTimeout(function () { window.location.href = "../Menu_Management_Main/SubAccount.aspx"; }, 1500);
            }
            else {
