...
{
    public partial class LineToken_Add : System.Web.UI.Page
    {
        ...
        public void AddLineToken_click(Object sender, EventArgs e)
        {
            try
            {
                int _idChk = _sql.CheckLineToken(NameGroup.Text, 0);
                if (_idChk == 0)
                {
